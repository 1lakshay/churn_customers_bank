Implemented the ANN architecture for classification taske on dataset: churn customers with problem statement of identifying the customers whih will leave the bank as the customers.
